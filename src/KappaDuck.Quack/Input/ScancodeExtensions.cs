...
public static class ScancodeExtensions
{
    extension(Scancode code)
    {
        ...
        /// </summary>
        /// <param name="keymod">The modifier to apply when translating the code to a key.</param>
        ...
        public Key ToKey(Keymod keymod = Keymod.None)
            => SDL3.GetKeyFromScancode(code, keymod, keyEvents: false);
    }
