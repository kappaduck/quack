...
/// <summary>
/// Provides functionality for keyboard input devices.
/// </summary>
public static class KeyboardDevices
{
    ...
    public static IEnumerable<KeyboardDevice> All
    {
        get
        {
            ReadOnlySpan<uint> ids = SDL3.Input.GetKeyboards(out _);
    ...
    /// </summary>
    public static bool HasKeyboard => SDL3.Input.HasKeyboard();

    /// <summary>
    /// Gets a value indicating whether a virtual keyboard is supported.
    /// </summary>
    public static bool HasVirtualKeyboard => SDL3.Input.HasScreenKeyboardSupport();
