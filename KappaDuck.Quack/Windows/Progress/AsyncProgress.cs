...
/// <summary>
/// Represents an asynchronous progress reporting for <see cref="TaskbarProgress"/>.
/// </summary>
public sealed class AsyncProgress : IDisposable
{
    private readonly TaskbarProgress _progressBar;
    private readonly CancellationTokenSource _cts = new();
    private readonly int _total;

    private int _current;

    internal AsyncProgress(TaskbarProgress progressBar, int total)
    {
    ...
    /// </summary>
    /// <remarks>
    /// This will stop any further progress reporting, triggering <see cref="TaskbarProgress.Cancelled"/> and
    ...
    /// </summary>
    /// <remarks>
    /// The total provided from <see cref="TaskbarProgress.StartAsync(Func{AsyncProgress, ValueTask}, int)"/> will be used as the maximum limit
