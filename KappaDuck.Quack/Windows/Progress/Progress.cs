...
/// <summary>
/// Represents a synchronous progress reporting for <see cref="TaskbarProgress"/>.
/// </summary>
public sealed class Progress
{
    ...
    internal Progress(TaskbarProgress progressBar, int total)
    {
    ...
    /// </summary>
    /// <remarks>
    /// The total provided from <see cref="TaskbarProgress.Start(Action{Progress}, int)"/> will be used as the maximum limit
