...
/// <summary>
/// Represents an angle in geometric space.
/// </summary>
    ...
    IUtf8SpanFormattable
{
    ...
    /// <summary>
    /// Implicitly converts degrees to an angle.
    /// </summary>
    /// <param name="degrees">The angle in degrees.</param>
    public static implicit operator Angle(float degrees) => FromDegrees(degrees);

    /// <summary>
    /// Explicitly converts an angle to degrees.
    /// </summary>
    /// <param name="angle">The angle.</param>
    public static explicit operator float(Angle angle) => angle.Degrees;
